...
```bash
curl -s https://raw.githubusercontent.com/SkinUps/docker-magento/nossl/lib/onelinesetup | bash -s -- magento2.test 2.3.5-p1
```

#### With sample data

```bash
curl -s https://raw.githubusercontent.com/SkinUps/docker-magento/nossl/lib/onelinesetup | bash -s -- magento2.test with-samples-2.3.5-p1
```
...
curl -s https://raw.githubusercontent.com/SkinUps/docker-magento/master/lib/template | bash
